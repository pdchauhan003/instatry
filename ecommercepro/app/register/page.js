...
function RegisterPage() {
  ...
  const handleFileClick = () => {
    // ✅ FORCE OPEN FILE PICKER (works on mobile)
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full border-2 border-dashed p-4 rounded-xl text-gray-600"
            >
              {image ? image.name : "Tap to upload profile picture"}
            </button>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-purple-700 text-white py-3 rounded-full"
          >
